  ...
  return (
    <div className="min-h-screen bg-background pb-20 md:pb-0">
      ...
      <header className="md:hidden flex items-center justify-between px-4 py-3 border-b border-border bg-surface">
        ...
        <h1 className="text-lg font-serif font-black text-primary tracking-tight">Settings</h1>
      ...
      <main className="container mx-auto px-4 md:px-6 py-8 max-w-6xl">
        <div className="text-center py-16">
          ...
          <h2 className="text-3xl font-serif font-bold text-primary mb-4">
            {locale === 'en' ? 'Settings' : 'ସେଟିଂସ୍'}
          </h2>
          <p className="text-lg text-secondary max-w-md mx-auto">
            {locale === 'en'
              ? 'Customize your reading preferences, notifications, and account settings. Coming soon!'
              : 'ଆପଣଙ୍କ ପଠନ ପସନ୍ଦ, ବିଜ୍ଞପ୍ତି ଏବଂ ଆକାଉଣ୍ଟ ସେଟିଂ କଷ୍ଟମାଇଜ୍ କରନ୍ତୁ। ଶୀଘ୍ର ଆସୁଛି!'
            }
          </p>
        </div>
      </main>
      ...
      <BottomNav locale={locale as Language} activeTab="settings" />
    </div>
  );
}
